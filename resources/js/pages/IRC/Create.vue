    ...
    <header class="bg-white shadow">
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
          <h1 class="text-3xl font-bold text-gray-900">Agregar Servidor IRC</h1>
          <Link
    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-6 sm:px-0">
        ...
        <div class="max-w-md mx-auto mt-8">
          <h3 class="text-lg font-medium text-gray-900 mb-4">Servidores IRC Populares</h3>
          <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="divide-y divide-gray-200">
              ...
              >
                <div class="flex justify-between items-center">
                  <div>
                    <p class="text-sm font-medium text-gray-900">{{ example.name }}</p>
                    <p class="text-sm text-gray-500">{{ example.host }}:{{ example.port }}</p>
                  </div>
                  <button
                    type="button"
